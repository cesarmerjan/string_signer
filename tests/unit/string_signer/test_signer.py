...
from src.string_signer.exceptions import (InvalidAlgorithm, InvalidSaltLength,
                                          InvalidSecretKey, InvalidSeparator,
                                          InvalidSignature,
...
class TestStringSigner(unittest.TestCase):
    ...
    def test_web_encoder_representation(self):
        ...
        self.assertIsInstance(string_signer.__str__(), str)
        self.assertIsInstance(string_signer.__repr__(), str)
